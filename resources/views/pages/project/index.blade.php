              ...
              @foreach($projects as $project)
                <form action="{{ route('project.update', $project->id) }}" method="POST">
                  ...
                  <tr class="@if($project->status_id == 5) bg-danger @elseif($project->status_id == 4) bg-success @endif">
                    ...
                    <td class="align-items-center text-center text-nowrap p-1"><input readonly style="min-width: 200px; width: 100%;" type="text" class="form-control" name="paid_developer" value="{{ $project->paid }}" required></td>
